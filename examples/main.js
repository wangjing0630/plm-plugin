...
import {AttributeInfo,DrawingList,PlmTree,DrawingListCopy,PlmTreeCopy} from '../packages/index'
Vue.use(AttributeInfo).use(DrawingList).use(PlmTree).use(DrawingListCopy).use(PlmTreeCopy)
